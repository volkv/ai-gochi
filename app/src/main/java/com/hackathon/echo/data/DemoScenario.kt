...
object DemoScriptedPhrases {
    val joyPairs = listOf(
        DemoMessagePair(
            "Сегодня защитил диплом на отлично! Очень волновался, но все получилось. Мои родители так гордятся мной!",
            "Поздравляю! Твой успех вдохновляет! 🌟"
        ),
        DemoMessagePair(
            "Получил предложение о работе мечты! Честно говоря, не ожидал, что это произойдет так быстро.",
            "Это потрясающе! Разделяю твое счастье! ✨"
        ),
        DemoMessagePair(
            "Встретил старого друга, было здорово! Поделились воспоминаниями из детства.",
            "Какой прекрасный день для радости! 🎉"
        ),
        DemoMessagePair(
            "Выиграл в лотерею небольшую сумму! Счастлив до безумия!",
    ...
    val sadnessPairs = listOf(
        DemoMessagePair(
            "Очень переживаю перед важной встречей... У меня болит сердце от волнения, боюсь не справиться.",
            "Я здесь, чтобы тебя поддержать 💙"
        ),
        DemoMessagePair(
            "Поссорился с близким человеком. Чувствую себя ужасно, не знаю как это исправить.",
            "Понимаю, что тебе сейчас тяжело"
        ),
        DemoMessagePair(
            "Чувствую себя потерянным и уставшим. Моя жизнь кажется бесцельной в последнее время.",
            "Я рядом. Ты не один в этом 💙"
        ),
        DemoMessagePair(
            "Не получил работу, на которую очень рассчитывал. Откровенно говоря, это мой провал.",
    ...
    val thoughtfulPairs = listOf(
        DemoMessagePair(
            "Размышляю о своем будущем и жизненном пути. Мои мысли постоянно возвращаются к вопросам о смысле жизни.",
            "Размышления помогают нам расти 🤔"
        ),
        DemoMessagePair(
            "Думаю о смысле происходящих событий в моей жизни. Хочу понять глубинные причины всего.",
            "Глубокие мысли ведут к мудрости"
        ),
        DemoMessagePair(
            "Анализирую свои поступки и их последствия. Пытаюсь разобраться в своих эмоциях и мотивах.",
            "Философские размышления - пища для души"
        ),
        DemoMessagePair(
            "Пытаюсь понять, правильный ли выбрал путь. Душа ищет ответы на важные вопросы.",
